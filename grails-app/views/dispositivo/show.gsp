...
<html>
    ...
    <body>
        ...
        <div id="show-dispositivo" class="content scaffold-show" role="main">
            ...
            <f:display bean="dispositivo" />
            <g:form resource="${this.dispositivo}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.dispositivo}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
